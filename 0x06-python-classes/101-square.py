...
class Square:
    ...
    a method to calculate the area, a method to print the square,
    and a custom __str__ method to print the square instance.
    """
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        -position (tuple, optional): The pos of the square. Defaults to (0, 0)

        Raises:
        -TypeError:If size is not an int or if pos is not tuple of 2 +ve ints
        -ValueError:If size is less than 0 or if pos contains non+ve ints
        """
        self.size = size
    ...
    def __validate_position(self, value=None):
        ...
        if value is not None:
            if not isinstance(value, tuple) or len(value) != 2:
                ...
                raise ValueError("position must be a tuple of 2 +ve ints")
